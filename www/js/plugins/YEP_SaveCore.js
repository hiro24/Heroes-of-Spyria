 ...
 * @default Please select a save slot. Press ESCAPE to cancel.
 *
 * @param Load Help
...
Window_SavefileList.prototype.drawItem = function(index) {
	...
	if (id == 13) {
		//this.drawFileId(autoid, rect.x + Window_Base._iconWidth + 4, rect.y);
		this.drawText(autoid, rect.x + Window_Base._iconWidth + 4, rect.y);
	} else {
