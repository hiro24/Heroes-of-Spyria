...
//---------------------------------------------------------------------------------------------
    ...
    Window_QuestInfo.prototype.initialize = function() {
        var xx = (GameusScripts["Config"]["QuestSystem"]["Reverse Layout"] || "false").toLowerCase() === "true" ? 0 : 360;
        ...
        Window_Selectable.prototype.initialize.call(this, xx, 0, Graphics.boxWidth - 360, Graphics.boxHeight);
...
//---------------------------------------------------------------------------------------------
    ...
    Window_Quests.prototype.initialize = function() {
        var xx = (GameusScripts["Config"]["QuestSystem"]["Reverse Layout"] || "false").toLowerCase() === "true" ? Graphics.boxWidth - 360 : 0;
...
//---------------------------------------------------------------------------------------------
    ...
    Window_QuestFilter.prototype.initialize = function() {
        this.qFilters = [
		    // GameusScripts["Config"]["QuestSystem"]["All Word"] || this.drawIcon(leftIcon, x + 8, y + 2) || "\I[15] All \I[1503]",
            GameusScripts["Config"]["QuestSystem"]["All Word"] || "\I[15] All \I[1503]",
    ...
    Window_QuestFilter.prototype.refresh = function() {
        ...
        this.filter = this.qFilters[this.filterIndex];
        this.contents.clear();
        this.drawIcon(leftIcon, 0, 0);
		this.drawText(this.filter, 0, 0, this.contentsWidth(), "center");
		this.drawIcon(rightIcon, 294, 0);
    };
//---------------------------------------------------------------------------------------------
// Scene_Quest
//---------------------------------------------------------------------------------------------
