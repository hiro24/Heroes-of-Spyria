 ...
 * ====================================================================== ===========================
 * Adds new weather effects.
 * Weather images should be recorded in the folder. (Img / weather /)
 * 
 * ====================================================================== ===========================
 * To activate the weather use the comment below through the PLUGIN COMMAND
 * 
 * Weather: TYPE: POWER: BLEND_TYPE: FILE_NAME
 * 
 * TYPE - Effect (from 0 to 20)
 *        0 - Wind 1 (Falling)
 *        1 - Wind 2 (Left Side)
 *        2 - Wind 3 (Zoom)
 *        3 - Spark 1
 ...
 *        16 - Cloud 2 (Front Zoom)
 *        17 - Cloud 3 (Strong)
 *        18 - Random 1
 *        19 - Random 2 (Zoom)
 *        20 - Random 3 (Cosmo)
 * 
 * POWER - Power of the weather. (Number of particles) (1 to 2000)
 * 
 * BLEND_TYPE - Blend Type (0 to 1)
 * 
 ...
 * 
 * ====================================================================== ===========================
 * To delete the weather use the comment below.
 * 
 * Clear_weather
 * 
 * ====================================================================== ===========================
 * ** History **
 * ====================================================================== ===========================
 * V2.0 - Plugin completely rewritten.
 *      - Improvement in performance (100% +)
 *      - 100% compatible with any resolution.
 *      - New effects (+15).
 *      - Improvement in old effects.
 *
 */
...
SpriteWeatherEX.prototype.setupRandom3 = function() {
     ...
     if (dir === 0) {
	     this.leftPos();
		 this.randomZoom(0.50);
		 this._sx = (this._speed + 0.3 + Math.random() * 0.5);
		 this._sy = -(this._speed + 0.1 + Math.random() * 0.5); 
	 } else {
         this.rightPos();
		 this.randomZoom(1.10);
		 this._sx = -(this._speed + 0.2 + Math.random() * 0.5);
		 this._sy = (this._speed + 0.1 + Math.random() * 0.5);
	 };
	 this.anchor.x = 0.5;
	 this.anchor.y = 0.5;
