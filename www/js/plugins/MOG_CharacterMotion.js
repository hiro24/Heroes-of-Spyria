...
Sprite_Character.prototype.setSwingData = function() {
		...
		// this._character._swingData[2] = 1;
		...
		this._character._swingData[5] = 0.0005; 	// EDITED FROM 0.005	
};
...
Sprite_Character.prototype.setFloatData = function() {
    	...
    	// var rz = 0.09;  // SPEED OF UP AND DOWN
		var rz = Math.min(Math.max((Math.random() * 0.5).toFixed(1),0.01),0.03);
		this._character._floatData[5] = rz;
		this._character._floatData[4] = 15;   // EDITED FROM 1
};
