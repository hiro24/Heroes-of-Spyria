...
Window_VictoryLevelUp.prototype.refresh = function() {
	...
	// Add voice file for leveling up - CUSTOM
	if (this._actor._actorId === 5) {
		Yanfly.Param.VAArray2 = [];
		Yanfly.Param.VAArray2.push("Hiro_Level_up_1");
		Yanfly.Param.VAArray2.push("Hiro_Level_up_2");
		// AudioManager.playSe({name: "Hiro_Level_up_1", pan: 0, pitch: 100, volume: 100});
		Yanfly.Param.VAPlayName2 = Yanfly.Param.VAArray2[Math.floor(Math.random() * Yanfly.Param.VAArray2.length)];
		AudioManager.playSe({name: Yanfly.Param.VAPlayName2, pan: 0, pitch: 100, volume: 100});
		console.log(Yanfly.Param.VAPlayName2);
		}
	if (this._actor._actorId === 6) {
		Yanfly.Param.VAArray3 = [];
		Yanfly.Param.VAArray3.push("Madilyn_Level_up_1");
		Yanfly.Param.VAArray3.push("Madilyn_Level_up_2");
		Yanfly.Param.VAPlayName3 = Yanfly.Param.VAArray3[Math.floor(Math.random() * Yanfly.Param.VAArray3.length)];
		AudioManager.playSe({name: Yanfly.Param.VAPlayName3, pan: 0, pitch: 100, volume: 100});
		console.log(Yanfly.Param.VAPlayName3);
		// AudioManager.playSe({name: "Madilyn_Level_up_1", pan: 0, pitch: 100, volume: 100});
	}
	if (this._actor._actorId === 7) {
		Yanfly.Param.VAArray4 = [];
		Yanfly.Param.VAArray4.push("Winter_Level_up_1");
		Yanfly.Param.VAArray4.push("Winter_Level_up_2");
		Yanfly.Param.VAPlayName4 = Yanfly.Param.VAArray4[Math.floor(Math.random() * Yanfly.Param.VAArray4.length)];
		AudioManager.playSe({name: Yanfly.Param.VAPlayName4, pan: 0, pitch: 100, volume: 100});
		console.log(Yanfly.Param.VAPlayName4);
		// AudioManager.playSe({name: "Winter_Level_up_2", pan: 0, pitch: 100, volume: 100});
	}
	if (this._actor._actorId === 8) {
		Yanfly.Param.VAArray5 = [];
		Yanfly.Param.VAArray5.push("Davos_Level_up_1");
		Yanfly.Param.VAArray5.push("Davos_Level_up_2");
		Yanfly.Param.VAPlayName5 = Yanfly.Param.VAArray5[Math.floor(Math.random() * Yanfly.Param.VAArray5.length)];
		AudioManager.playSe({name: Yanfly.Param.VAPlayName5, pan: 0, pitch: 100, volume: 100});
		console.log(Yanfly.Param.VAPlayName5);
	}
	if (this._actor._actorId === 9) {
		Yanfly.Param.VAArray6 = [];
		Yanfly.Param.VAArray6.push("Auryn_Level_up_1");
		Yanfly.Param.VAArray6.push("Auryn_Level_up_2");
		Yanfly.Param.VAPlayName6 = Yanfly.Param.VAArray6[Math.floor(Math.random() * Yanfly.Param.VAArray6.length)];
		AudioManager.playSe({name: Yanfly.Param.VAPlayName6, pan: 0, pitch: 100, volume: 100});
		console.log(Yanfly.Param.VAPlayName6);
	}
	if (this._actor._actorId === 21) {
		Yanfly.Param.VAArray7 = [];
		Yanfly.Param.VAArray7.push("Sarah_Level_up_1");
		Yanfly.Param.VAArray7.push("Sarah_Level_up_2");
		Yanfly.Param.VAPlayName7 = Yanfly.Param.VAArray7[Math.floor(Math.random() * Yanfly.Param.VAArray7.length)];
		AudioManager.playSe({name: Yanfly.Param.VAPlayName7, pan: 0, pitch: 100, volume: 100});
	}
	if (this._actor._actorId === 22) {
		Yanfly.Param.VAArray8 = [];
		Yanfly.Param.VAArray8.push("Rex_Level_up_1");
		Yanfly.Param.VAArray8.push("Rex_Level_up_2");
		Yanfly.Param.VAPlayName8 = Yanfly.Param.VAArray8[Math.floor(Math.random() * Yanfly.Param.VAArray8.length)];
		AudioManager.playSe({name: Yanfly.Param.VAPlayName8, pan: 0, pitch: 100, volume: 100});
	}
};
