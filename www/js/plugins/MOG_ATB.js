...
/*:
 * @plugindesc (v0.2 *) Sistema de batalha em tempo real.
 * @author Moghunter
 *
 * @param ATB Mode
 ...
 * @help  
 * =============================================================================
 * +++ MOG - Active Time Battle [ATB] (v0.2 *) +++
 * By Moghunter 
 ...
 *
 * =============================================================================
 * - WHAT'S  NEW (version 0.2b) 
 * =============================================================================
 * - (NEW)     - Plugins parameters compatíveis com RM1.5+
 * - (BUG FIX) - Correção da animação inicial do plugin Emerge Motion.
 * 
 */
